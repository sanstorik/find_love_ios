...
extension UIViewController {
    func customizedAlertController(title: String, description: String) -> PMAlertController {
        ...
        alert.alertDescription.font = alert.alertTitle.font.withHeightConstant(multiplier: 0.045, view: view)
    ...
    func customizedAlertAction(title: String?, action: (() -> Void)? = nil) -> PMAlertAction {
        ...
        action.titleLabel?.font = action.titleLabel?.font.withHeightConstant(multiplier: 0.045, view: view)
